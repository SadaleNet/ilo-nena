// Modified based on rv003usb's example
// https://github.com/cnlohr/rv003usb/blob/f637624a/demo_pikokey_hid/usb_config.h
// The repo of the source file that I took it from is under MIT License

#ifndef _USB_CONFIG_H
#define _USB_CONFIG_H

// Configure USB VID, PID and device revision
#define USB_VID (0x1209) // Available on https://pid.codes/
#define USB_PID (0x6362) // NENA is 6362 on T9 keypad
#define USB_REV (0x0000) // Manufaturer's revision ID

// USB String Descriptor
#define STR_MANUFACTURER u"jan Sate (sadale.net)"
#define STR_PRODUCT      u"ilo nena"
#define STR_SERIAL       u""
...
static const uint8_t device_descriptor[] = {
	...
	(uint8_t)(USB_VID&0xFF), (uint8_t)((USB_VID&0xFF00)>>8), //ID Vendor
	(uint8_t)(USB_PID&0xFF), (uint8_t)((USB_PID&0xFF00)>>8), //ID Product
	(uint8_t)(USB_REV&0xFF), (uint8_t)((USB_REV&0xFF00)>>8), //ID Rev
...
//Mostly the same as "Appendix E.6" of "Device Class Definition for Human Interface Devices (HID) Firmware Specification Version 1.11" with the LED part removed.
static const uint8_t keyboard_hid_desc[] = {   /* USB report descriptor */
	...
	HID_COLLECTION ( HID_COLLECTION_APPLICATION ),    // COLLECTION (Application)
		...
		HID_REPORT_COUNT( 8 ),                        //     REPORT_COUNT (8)
	    ...
	    HID_USAGE_MAX( 0xFF ),                         //     USAGE_MAXIMUM (Keyboard Application)(101) (Now 255)
...
static const uint8_t config_descriptor[] = {  //Mostly stolen from a USB mouse I found.
	...
	// Keyboard, Interface Descriptor  (It is unusual that this would be here)
	9,					// bLength
	4,					// bDescriptorType
	...
	0x01,					// bInterfaceSubClass (0x01 = Boot Interface Subclass)
	...
	0x10,0x01,		// bcdHID HID class specification release number (bcd 1.1)
	0x00, // bCountryCode
	0x01, // bNumDescriptors Number of HID class descriptors to follow
	0x22, // bDescriptorType (HID)
	sizeof(keyboard_hid_desc), 0x00, // wDescriptorLength
